...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Preview the next paper/test runbook day.")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        result = {
            ...
            "mode": "PREVIEW",
            "reason": "calendar_configuration_invalid",
            "blockers": [f"{type(exc).__name__}:{exc}"],
            "safe_to_prepare": False,
            "next_required_action": "Fix the calendar configuration before preparing a new runbook day.",
        }
