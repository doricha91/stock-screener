...
def generate_paper_daily_review_summary() -> dict:
    ...
    write_markdown(daily_summary_path, render_paper_daily_review_summary(summary))
    write_markdown(report_index_path, render_paper_report_index(report_rows))
    return {
