...
def main_bbs_test():
    """
    '볼린저 밴드 스퀴즈' 전략을 'SPY' 종목에 대해 1회 실행합니다.
    """

    # --- 1. 테스트할 종목 및 전략 설정 ---
    SYMBOL_TO_TEST = 'TSLA'  # (변동성 돌파 전략이므로 변동성이 큰 TSLA로 테스트)
    STRATEGY_NAME = 'bbs'  # (★) 실행할 전략 이름

    print("=" * 50)
    print(f"볼린저 밴드 스퀴즈 전략 백테스트를 시작합니다.")
