...
def commit_manual_review_preview(
    *,
    ...
    target_log_path = review_log_path or (paper_reviews_dir() / "paper_manual_review_log.csv")
    template_csv_path = template_path or (paper_reviews_dir() / "paper_manual_review_log_template.csv")
    output_reports_dir = reports_dir or paper_reports_dir()

    existing_rows = load_existing_paper_manual_review_log_rows(target_log_path)
    template_by_key = _load_template_index(template_csv_path)
    ...
    backups = _create_dev_backups(review_date=review_date, targets={"paper_manual_review_log": target_log_path})
...
def _load_template_index(template_path: Path) -> dict[tuple[str, str, str], dict[str, str]]:
